...
export default function About() {
  return (
    <section id="about" className="min-h-[60vh] flex items-center justify-center py-12 px-4 md:px-8 animate-fadeIn">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-6xl mx-auto">
        <Image
          ...
          width={256}
          height={256}
          className="rounded-lg object-cover shadow-2xl border-4 border-[#00ADB5] hover:scale-105 transition-transform duration-300 animate-fadeIn w-48 h-48 md:w-64 md:h-64"
          style={{ animationDelay: '0.3s' }}
        />
        <Card className="backdrop-blur-md bg-white/10 border-white/20 p-6 md:p-8 shadow-2xl animate-fadeIn w-full md:w-auto" style={{ animationDelay: '0.6s' }}>
